...
#         override_user_id=ride.override_user_id,
...
#     # Determine who the actual rider is (self or other employee)
#     rider_id = ride.target_employee_id if ride.target_type == "other" else user_id
...
#     "new_status": new_ride.status.value
# })
#     # 🔔 Notify the delegated rider (if the ride was for someone else)
#     if ride.target_type == "other" and ride.target_employee_id:
#         delegated_notification = create_system_notification(
#             user_id=ride.target_employee_id,
